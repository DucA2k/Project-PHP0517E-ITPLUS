          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                         <li><a  href="{{ url('admin/contact') }}">Show</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                         <li><a  href="{{ url('admin/slide') }}">Show</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                         <li><a  href="{{ url('admin/news') }}">Show</a></li>
                        <li><a  href="{{ url('admin/news/create') }}">Create New Slide</a></li>
                      </ul>
                  </li>
              </ul>
              <!-- sidebar menu end-->
